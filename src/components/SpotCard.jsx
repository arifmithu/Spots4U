    ...
    <div className="card card-side bg-base-100 shadow-xl">
      ...
      <div className="card-body w-2/3">
        ...
        <p className="font-bold">
          {" "}
          Cost : <span className="text-red-600 font-bold text-lg">
            {cost}
          </span>{" "}
          Taka per day
        </p>
        <p className="font-bold">
          ...
          <span className="text-red-600 font-bold text-lg">{visitor}</span>
        </p>
        <p className="font-bold">
          Travel Time :{" "}
        ...
        <p className="font-bold">
          Seasonality :{" "}
          <span className="text-red-600 font-bold text-lg"> {seasonality}</span>{" "}
        </p>
